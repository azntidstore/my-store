...
export default function Header({ menuItems, isLoading: loadingMenus }: { menuItems: MenuItem[], isLoading?: boolean }) {
      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex gap-6">
            {loadingMenus ? <Loader2 className="h-5 w-5 animate-spin" /> : 
            <NavigationMenu>
                <NavigationMenuList>
