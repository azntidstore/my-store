...
export default function CartPage() {
  ...
  useEffect(() => {
    ...
    const shippingQuery = query(collection(firestore, 'shipping-zones'));
    const unsubShipping = onSnapshot(shippingQuery, (snapshot) => {
        setShippingZones(snapshot.docs.map(doc => ({ id: doc.id, ...doc.data() } as ShippingZone)));
